...
<th><div align="center"><em><font color="#0033FF">Action</em></div></th> 
	...
	$z="select * from co_report where re_from='admin' and re_to='$username'";
	$z1=mysql_query($z);	
	...
	{   //report_msg
		...
		<tr><td> <?php	echo $row['re_from']; ?></td>
      	<td><a href="userhome.php?view=view_reports1&id1=<?php echo $row['r_id'];?>"><?php echo $row['re_title'];?></a>
		</td>
    <!--  <td><?php	//echo $row['feedback']; ?></td>-->
    <td><a href="userhome.php?view=view_reports&id=<?php echo $row['r_id'];?>&stat=delete">Delete</a></td>
      </tr>
