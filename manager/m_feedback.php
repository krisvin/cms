...
mysql_query("insert into feedback values('','$a','admin','$c','$d')");

echo"<script>alert('Feedback Send Successfully')</script>";	
echo"<script>window.location='servicemgrhome.php?view=m_feedback'</script>";
}
...
<form name="form1" method="post" action="">
  <center><table width="569" height="300" border="0">
    ...
    <tr>
      <td>To</td>
      <td><input type="text" name="tos" id="tos" value="<?php echo 'admin'?>" readonly="readonly" style="width:252px" /></td>
    </tr>
    <tr>
      <td>Subject</td>
...
<script  language="javascript" type="text/javascript">
 ...
 frmvalidator.addValidation("from","req","Rnter the Erom Address!");
   var frmvalidator = new Validator("form1");
