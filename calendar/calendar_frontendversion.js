...
var pathToImages = 'inc/addins/calendar/images/';	// Relative to your HTML file
...
function closeCalendar(){
	...
	//DateManupulations('','haccounts_DOR','haccounts_DOE');
	if (globalexcecutethis != "") { eval(globalexcecutethis); }
}
...
function displayCalendar(inputField,format,buttonObj,displayTime,timeInput,excecutethis)
{
	...
	updateMinuteDiv();
	updateHourDiv();
	globalexcecutethis=excecutethis;
