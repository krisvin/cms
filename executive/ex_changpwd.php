<div class="templatemo_box">
   	    <h2 align="center">Executive Change Password</h2>
...
$s="select * from login where username='$user'";
	...
	if($opass==$val['password'])
	{
			...
			$s11="update service_exec set ex_pwd='$npass' where ex_una='$user'";
			mysql_query($s11);
			echo "<script> alert('Password Changed!') </script>";
			echo "<script> window.location='executivehome.php'</script>";
		
		}
	else
	{
		echo "<script> alert('Check your Password!') </script>";
		echo "<script> window.location='executivehome.php?view=ex_changpwd'</script>";
