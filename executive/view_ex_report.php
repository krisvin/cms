...
<body>
<table width="100%" height="85" border="0" cellpadding="5">

  <tr bgcolor="#999999">
<th height="40"><font color="#0033FF"><em>Send From</em></th> 
...
<th><div align="center"><em><font color="#0033FF">Action</em></div></th> 
	...
	{   //report_msg
		...
		<tr><td> <?php	echo $row['re_from']; ?></td>
      	<td><a href="executivehome.php?view=view_ex_report1&id1=<?php echo $row['r_id'];?>"><?php echo $row['re_title'];?></a>
		</td>
    <!--  <td><?php	//echo $row['feedback']; ?></td>-->
    <td><a href="executivehome.php?view=view_ex_report&id=<?php echo $row['r_id'];?>&stat=delete">Delete</a></td>
      </tr>
